...
export default function Locations() {
  ...
  // Mock warehouse data for dropdown
  const warehouses = [
    { id: 1, name: 'Main Distribution Center', code: 'MDC-01' },
    { id: 2, name: 'Secondary Warehouse', code: 'WH-02' },
    { id: 3, name: 'Storage Facility A', code: 'SFA-01' }
  ];
      ...
      <div style={{ minHeight: '100vh', background: 'var(--bg)' }}>
        ...
        <div className="page-container" style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div className="breadcrumb">
            ...
            <span>/</span>
            <span style={{ color: 'var(--text)', fontWeight: '600' }}>Locations</span>
          </div>
          ...
          <div className="flex-between" style={{ marginBottom: '24px' }}>
            <div>
              ...
              <p className="text-muted" style={{ fontSize: '14px' }}>
                Manage internal warehouse locations (racks, shelves, zones)
              </p>
            </div>
              ...
              <div className="flex-between">
                <div>
                  ...
                  <p className="text-muted" style={{ fontSize: '12px', marginTop: '2px' }}>
                    Enter location details and assign to warehouse
                  </p>
                </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="e.g., Rack A, Shelf B-1, Zone C"
                  />
                  <p className="form-helper">
                    The name of the storage location within the warehouse
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="form-helper">
                    The parent warehouse that contains this location
                  </p>
                </div>
                ...
                <div className="info-banner">
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: '12px', color: '#78350f' }}>
                      Locations help organize inventory within warehouses. Products can be assigned to specific locations for efficient stock management and picking operations.
                    </p>
                  </div>
                </div>
              </div>
